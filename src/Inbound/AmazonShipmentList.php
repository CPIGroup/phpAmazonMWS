<?php namespace CPIGroup\Inbound;
    /**
    ...
    class AmazonShipmentList extends AmazonInboundCore implements \Iterator
    {
        ...
        public function setTimeLimits( $lower = null, $upper = null )
        {
            ...
            try {
                ...
                if (isset( $this->options[ 'LastUpdatedAfter' ] ) && isset( $this->options[ 'LastUpdatedBefore' ] )
        ...
        public function fetchShipments( $r = true )
        {
            ...
            if (!array_key_exists( 'ShipmentStatusList.member.1', $this->options )
         ...
         *
         * @return array|AmazonShipmentItemList <i>AmazonShipmentItemList</i> object or array of objects, or
         *                                      <b>FALSE</b> if non-numeric index
         */
