<?php namespace CPIGroup\Order;
    ...
    class AmazonOrderList extends AmazonOrderCore implements \Iterator
    {
         ...
         * will be removed: SellerOrderId, OrderStatus, PaymentMethod, FulfillmentChannel, LastUpdatedAfter,
         * LastUpdatedBefore.
         *
         ...
         * will be removed: BuyerEmail, OrderStatus, PaymentMethod, FulfillmentChannel, LastUpdatedAfter,
         * LastUpdatedBefore.
         *
         * @param array|string $s <p>A list of Payment Methods, or a single type string. Set to NULL to remove the
         *                        option.</p>
         *
         * @return boolean <b>FALSE</b> if improper input
         */
         ...
         *
         * @return array|AmazonOrderItemList <i>AmazonOrderItemList</i> object or array of objects, or <b>FALSE</b> if
         *                                   non-numeric index
         */
