...
class AmazonOrderSetTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonOrderSet(null, true, null, __DIR__ . '/../../test-config.php');
    }
    ...
    public function testSetUp(){
        $obj = new AmazonOrderSet('77', true, null, __DIR__ . '/../../test-config.php');
    ...
    public function testFetchItems(){
        ...
        $o = new AmazonOrderList(true, null, __DIR__ . '/../../test-config.php');
